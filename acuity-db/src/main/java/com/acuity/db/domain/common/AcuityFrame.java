...
import static com.acuity.db.domain.common.LoginFrame.ACUITY_BLUE;
...
public class AcuityFrame extends JFrame implements MouseListener, MouseMotionListener {
	...
	private Panel createTopPanel() {
		...
		panel.setBackground(ACUITY_BLUE);
		panel.setPreferredSize(new Dimension(APPLET_SIZE.width, 30));
